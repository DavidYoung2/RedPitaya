...
/*
 * Decimation (usually from internal 8k -> output 2k) :: NOT ANY MORE !!!
*/
 ...
 * Input & Outputs of length SPECTR_OUT_SIG_LEN (decimated length) :: NOT ANY MORE !!!
 */
